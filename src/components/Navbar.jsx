...
export const Navbar = () =>{
    ...
    return(
        <div className="w-full sticky top-0 left-0  bg-yinMnBlue  ">
            <div className="flex flex-row p-1 items-center justify-between">
                <div className="flex hover:cursor-pointer"onClick={homeClick}>
                    <img  src={logo} className="h-20 object-contain hover:cursor-pointer"/> 
                    <h1  className="text-3xl hover:cursor-pointer flex justify-center items-center " style={{ marginLeft: '0' }}> Casual Life Linker</h1>  
                </div>

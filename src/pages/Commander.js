    ...
    return(
        <div className="flex flex-wrap justify-center items-center ">
            ...
            <div className="bg-gray-500 w-96 flex flex-col p-6 rounded-md">
                <h1 className="text-white-500 text-3xl">
                    Welcome to Commander
                </h1>
                
                <form className="flex flex-col ">
                    <label className="bg-gray-500 text-2xl mt-4"> Player Count </label>
                    <input className="focus: outline-none focus:ring-0 focus:border-gray-600"
                    type="text"
                    id ="userCount"
           ...
           { display && (<div className=" flex flex-wrap">
            ...
            {hiddenDice4 && <div className="flex flex-col items-center">
                <DiceFour  visible={diceVisible}/>
                <h1 className="hover:cursor-pointer text-white hover:text-red-500" onClick={diceInvisibleHandle}> Close </h1>    
            </div> }

            {hiddenDice20 && <div className="flex flex-col items-center">
                <DiceTwenty visible={diceVisible}/>
                <h1 className="hover:cursor-pointer text-white hover:text-red-500" onClick={diceInvisibleHandle}> Close </h1>    
            </div> }

            {hiddenDice6 && <div className="flex flex-col items-center">
